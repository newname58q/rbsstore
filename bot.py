...
async def start(event):
  await event.reply("**TaggerBots**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim Bu tür botlar için Kod Sahibi ile iletişime geçin @jackdanielssx ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/jacktaggerbot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/jackdanielssx'),
                      Button.url('💻 Developer', 'https://t.me/jackdanielssx'),
...
print(">> Bot çalıyor merak etme 🚀 @jackdanielssx bilgi alabilirsin <<")
